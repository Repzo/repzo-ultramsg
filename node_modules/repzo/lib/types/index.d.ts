...
export declare namespace Service {
  ...
  namespace BankList {
    ...
    namespace Get {
      type ID = string;
      type Result = BankListSchema;
    }
    namespace Create {
      interface Body extends BankListBody {
        name: string;
      }
      type Result = BankListSchema;
    }
  ...
  namespace App {
    ...
    export namespace Get {
      ...
      type Result = Schema | Schema_with_populated_AvailableApp;
    }
    export namespace Create {
      interface Body extends AppBody {
        name: string;
        available_app: string;
        formData: any;
      }
