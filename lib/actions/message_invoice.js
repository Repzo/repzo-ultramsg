...
export const message_invoice = async (event, options) => {
    ...
    try {
        ...
        await actionLog
            .addDetail(`Repzo Ultramsg: Started Sending a Message - ${(_c = body === null || body === void 0 ? void 0 : body.serial_number) === null || _c === void 0 ? void 0 : _c.formatted}`)
            .commit();
        ...
        await actionLog
            .addDetail(`Repzo Ultramsg: Message Body - Dear ${ultramsg_client_body.clientName}, your total invoice is ${parseInt(ultramsg_client_body.total) / 1000} ${ultramsg_client_body.currency}`, ultramsg_client_body)
            .commit();
